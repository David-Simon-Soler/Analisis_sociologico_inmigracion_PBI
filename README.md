...
Menciono para terminar que este breve proyecto nace tras observar que los informes académicos como el que hice, aunque estan muy bien desarrollados, son extensos y tediosos de leer. Mi idea con este dashboard es que sea facil de comprender y que el usuario sea capaz de observarlo de forma sencilla, ya que no es lo mismo un informe hecho por y para el ámbito académico, que un dashboard que muestra exactamente lo que necesitas comprender, datos reales y filtrados. 
